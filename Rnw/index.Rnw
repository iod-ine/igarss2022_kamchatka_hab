...
<<s2_september9, fig.cap="Chlorophyll concentration for September 9th, 2020 derived from level 1 Sentinel-2 data with C2RCC atmospheric correction algorithm.", out.width="\\linewidth", fig.width=4.1, fig.height=5.1>>=
...
<<sst, fig.cap="Sea surface temperature anomalies for September of 2020 compared to three previous years.">>=
